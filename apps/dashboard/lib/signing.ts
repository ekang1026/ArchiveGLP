...
/**
 * Duplicated verbatim from apps/api/src/lib/signing.ts. Must stay in
 * lockstep with apps/agent/archiveglp_agent/signing.py (the canonical
 * string format is part of the wire protocol).
 *
 * Tech debt: pull this + lib/db.ts into a shared @archiveglp/signing
 * and @archiveglp/dbclient package once the Supabase swap settles.
 */
